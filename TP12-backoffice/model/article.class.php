...
// Est utilisé pour calculer le nombre de pages
 ...
 public function create() {
    ...
    $checkSql = "SELECT COUNT(*) FROM article WHERE ref = :ref";
    $checkStmt = $dao->prepare($checkSql);
    $checkStmt->bindValue(':ref', $this->ref, PDO::PARAM_INT);
    $checkStmt->execute();
    ...
    $sql = "INSERT INTO article (ref, libelle, categorie, prix, image) 
            VALUES (:ref, :libelle, :categorie, :prix, :image)";
    
    $stmt = $dao->prepare($sql);
    
    $stmt->bindValue(':ref', $this->ref, PDO::PARAM_INT);
    $stmt->bindValue(':libelle', $this->libelle, PDO::PARAM_STR);
    $stmt->bindValue(':categorie', $this->categorie->getId(), PDO::PARAM_INT);
    $stmt->bindValue(':prix', $this->prix, PDO::PARAM_STR);
    ...
    return $success;
        ...
        $sql = "UPDATE article 
                SET libelle = :libelle, categorie = :categorie, prix = :prix, image = :image 
                WHERE ref = :ref";
